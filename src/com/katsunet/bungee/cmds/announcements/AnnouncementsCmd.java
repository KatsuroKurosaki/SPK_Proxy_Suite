package com.katsunet.bungee.cmds.announcements;
...
public class AnnouncementsCmd extends Command {

	private Main plugin;
	
	public AnnouncementsCmd(Main plugin){
		super("announcements",Global.PERM_ANNOUNCEMENTS,new String[]{"ann"});
		this.plugin=plugin;
	}
