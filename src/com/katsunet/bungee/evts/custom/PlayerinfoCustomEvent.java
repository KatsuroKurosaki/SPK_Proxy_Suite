...
public class PlayerinfoCustomEvent extends Event {
	...
	public PlayerinfoCustomEvent(boolean success, CommandSender cmds, String playername, String email, String rank,
			String rankuntil, int connections, String registerdate, String lastlogin, String lastIp) {
		this.success = success;
		this.cmds = cmds;
