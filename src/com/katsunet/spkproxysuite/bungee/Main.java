...
public class Main extends Plugin {
	...
	public void onEnable() {
		...
		if (this._mainCnf.getYaml().getInt(Global.CONFNODE_VERSION) != Global.BUNGEE_MAIN_CONFIG_VERSION) {
			this.getLogger().info("Detected old " + Global.BUNGEE_MAIN_PLUGIN_CONFIG_FILE
					+ " config file; overwriting with current.");
		...
		if (this._dbCnf.getYaml().getInt(Global.CONFNODE_VERSION) != Global.DATABASE_CONFIG_VERSION) {
			this.getLogger()
					.info("Detected old " + Global.DATABASE_CONFIG_FILE + " config file; overwriting with current.");
		...
		// this.getProxy().getPluginManager().registerListener(this, new
		// ProxyPingEvt(this)); // TODO: This
