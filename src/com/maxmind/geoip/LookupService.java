...
public class LookupService {
	...
	private static final String[] countryCode = { "--", "AP", "EU", "AD", "AE", "AF", "AG", "AI", "AL", "AM", "CW",
			...
			"EH", "ER", "ES", "ET", "FI", "FJ", "FK", "FM", "FO", "FR", "SX", "GA", "GB", "GD", "GE", "GF", "GH", "GI",
			...
			"A2", "O1", "AX", "GG", "IM", "JE", "BL", "MF", "BQ", "SS", "O1" };
			...
			if (delim[0] == -1 && delim[1] == -1 && delim[2] == -1) {
				...
				if (databaseType == DatabaseInfo.REGION_EDITION_REV0) {
					...
					recordLength = STANDARD_RECORD_LENGTH;
						...
						|| databaseType == DatabaseInfo.ORG_EDITION_V6 || databaseType == DatabaseInfo.ISP_EDITION
						|| databaseType == DatabaseInfo.ISP_EDITION_V6 || databaseType == DatabaseInfo.DOMAIN_EDITION
						|| databaseType == DatabaseInfo.DOMAIN_EDITION_V6 || databaseType == DatabaseInfo.ASNUM_EDITION
